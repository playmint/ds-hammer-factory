        ...
        components: [
            {
                ...
                id: 'farmour',
                title: 'fArmour',
                summary: "We make Farms' approved headwear. 20 Unobtanium to be both poweeful and fashionionable",
                content: [
                    {
                        id: 'default',
                        type: 'inline',
                        buttons: [{ text: 'Craft headphones', type: 'action', action: craft, disabled: !canCraft }],
                    },
                ],
            },
        ],
