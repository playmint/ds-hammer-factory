...
import {PaperFactoryV2} from "../src/PaperFactory_v2.sol";
...
contract Deployer is Script {
    ...
    function run() public {
        ...
        string memory defaultBuildingKindName = "Paper Mill v2";
        ...
        uint64 buildingKindExtensionID = uint64(vm.envOr("BUILDING_KIND_EXTENSION_ID", uint64(8419883233310)));
        ...
        PaperFactoryV2 extensionContract = new PaperFactoryV2(ds);
        dispatcher.dispatch(
        ...
        string memory clientPluginSrc = vm.readFile("src/PaperFactory_v2.js");
        dispatcher.dispatch(
            abi.encodeCall(
