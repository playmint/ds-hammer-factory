...
import {DuckFanatic} from "../src/DuckFanatic.sol";
...
contract Deployer is Script {
    ...
    function run() public {
        ...
        string memory defaultBuildingKindName = "Duck Fanatic";
        ...
        DuckFanatic extensionContract = new DuckFanatic(ds);
        dispatcher.dispatch(
        ...
        string memory clientPluginSrc = vm.readFile("src/DuckFanatic.js");
        dispatcher.dispatch(
            abi.encodeCall(
