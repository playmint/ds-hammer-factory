...
import {PaperFactory} from "../src/PaperFactory.sol";
...
contract Deployer is Script {
    ...
    function run() public {
        ...
        string memory defaultBuildingKindName = "Paper Mill";
        ...
        uint64 buildingKindExtensionID = uint64(vm.envOr("BUILDING_KIND_EXTENSION_ID", uint64(84132473233310)));
        ...
        PaperFactory extensionContract = new PaperFactory(ds);
        dispatcher.dispatch(
        ...
        string memory clientPluginSrc = vm.readFile("src/PaperFactory.js");
        dispatcher.dispatch(
            abi.encodeCall(
