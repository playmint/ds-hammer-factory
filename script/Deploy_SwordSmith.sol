...
import {SwordSmith } from "../src/SwordSmith.sol";
...
contract Deployer is Script {
    ...
    function run() public {
        ...
        string memory defaultBuildingKindName = "Tutorial SwordSmith";
        ...
        SwordSmith extensionContract = new SwordSmith(ds);
        dispatcher.dispatch(
        ...
        string memory clientPluginSrc = vm.readFile("src/SwordSmith.js");
        dispatcher.dispatch(
            abi.encodeCall(
