...
contract Deployer is Script {
    ...
    function run() public {
        ...
        string memory defaultBuildingKindName = "AnalyticsHut";
        ...
        AnalyticsHut extensionContract = new AnalyticsHut();
        dispatcher.dispatch(
        ...
        string memory clientPluginSrc = vm.readFile("src/AnalyticsHut.js");
        dispatcher.dispatch(
            abi.encodeCall(
