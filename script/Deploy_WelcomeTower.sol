...
contract Deployer is Script {
    ...
    function run() public {
        ...
        string memory defaultBuildingKindName = "Welcome To DawnSeekers";
        ...
        uint64 buildingKindExtensionID = uint64(vm.envOr("BUILDING_KIND_EXTENSION_ID", uint64(54375664722)));
